...
export const commandDefinitions: CommandDefinition[] = [
  ...
  },
  {
    id: "app.goToHeading",
    label: "Go to Heading",
    menuPath: "Edit/Go to Heading",
    category: "Navigation",
    searchTerms: ["headings", "jump", "toc", "outline", "structure"],
    paletteIntent: "palette",
    availability: "markdownEdit",
    // Palette-only: Cmd/Ctrl+Shift+O is owned by app.toggleMarkdownOutline;
    // no conflict-free default binding exists, which the plan permits.
    binding: { mac: "none", windows: "none" },
  },
  {
  ...
  },
  {
    ...
    category: "Edit",
    searchTerms: ["mark", "flag", "pin"],
    paletteIntent: "palette",
    availability: "document",
    binding: { mac: "Cmd+F2", windows: "Ctrl+F2" },
  },
  {
    id: "edit.nextBookmark",
    label: "Next Bookmark",
    menuPath: "Edit/Next Bookmark",
    category: "Edit",
    searchTerms: ["mark", "flag", "jump"],
    paletteIntent: "palette",
    availability: "document",
    binding: { mac: "F2", windows: "F2" },
  },
  {
    id: "edit.previousBookmark",
    label: "Previous Bookmark",
    menuPath: "Edit/Previous Bookmark",
    category: "Edit",
    searchTerms: ["mark", "flag", "jump"],
    paletteIntent: "palette",
    availability: "document",
    binding: { mac: "Shift+F2", windows: "Shift+F2" },
  },
  {
    id: "edit.clearBookmarks",
    label: "Clear All Bookmarks",
    menuPath: "Edit/Clear All Bookmarks",
    category: "Edit",
    searchTerms: ["mark", "flag", "remove"],
    paletteIntent: "palette",
    availability: "document",
    binding: { mac: "none", windows: "none" },
  },
  {
    id: "edit.listBookmarks",
    label: "List Bookmarks",
    menuPath: "Hidden/List Bookmarks",
    category: "Edit",
    searchTerms: ["mark", "flag", "overview"],
    paletteIntent: "palette",
    availability: "document",
    binding: { mac: "none", windows: "none" },
  },
