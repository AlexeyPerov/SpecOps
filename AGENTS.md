...
- **Changelog.** Log all changes to `specs/changelog.md`. Create that file if it does not exist. Use dated entries or an existing section style already used in that file.
