...
- **Branching.** Do not create separate feature branches or pull requests for changes. Commit and push directly to `master` unless the user explicitly asks you to use a branch or PR workflow instead.
