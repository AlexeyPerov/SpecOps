...
#### Task M5.2-1: Add bounded local-word completion source [Score:6] [Agent:medium]
...
#### Task M5.2-2: Trigger, settings, and completion UX [Score:6] [Agent:medium]
...
#### Task M5.2-3: Validation [Score:4] [Agent:medium]
...
- [ ] Local document-word completion works manually.
- [ ] Automatic suggestions are bounded and configurable.
- [ ] Tab/indent and multi-cursor behavior are tested.
- [ ] No workspace-wide or AI completion is introduced.
